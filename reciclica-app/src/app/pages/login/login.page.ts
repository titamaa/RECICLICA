...
export class LoginPage implements OnInit, OnDestroy {
  ...
  form!: FormGroup;
  loginStateSubscription: Subscription | null = null;
  ...
  login() {
    this.store.dispatch(login({email: this.form.get('email')?.value, password: this.form.get('password')?.value})); // Gunakan store untuk dispatch action login
  }
